    ...
    <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-8 px-6 py-16">
      ...
      <div className="flex flex-col gap-6 text-body leading-relaxed text-charcoal/80">
        ...
        <ul className="list-disc pl-5">
          ...
          <li><strong>&ldquo;Download Catalog&rdquo; form:</strong> your name and email address, if this form is currently switched on for the catalog download.</li>
        </ul>
        <p>
        ...
        <h2 className="text-h3 font-semibold text-charcoal">How we use it</h2>
        <p>
        ...
        <h2 className="text-h3 font-semibold text-charcoal">Where it goes</h2>
        <p>
          When you submit either form, your details are sent securely to a
          private spreadsheet that only KIBO can access, so our team can
          follow up with you. No third-party marketing company, ad network,
          or data broker receives this information.
        </p>
        <p>
        ...
        <h2 className="text-h3 font-semibold text-charcoal">Cookies &amp; analytics</h2>
        <p>
          This site uses a privacy-friendly analytics tool (Vercel Analytics)
          to understand, in aggregate, how many people visit and which pages
          they view. It does not use cookies, does not collect your name or
          email, and does not track you across other websites — it can&apos;t
          identify you personally, only that &ldquo;a visit happened.&rdquo;
        </p>
        <p>
        ...
        <h2 className="text-h3 font-semibold text-charcoal">How long we keep it</h2>
        <p>
        ...
        <h2 className="text-h3 font-semibold text-charcoal">Your choices</h2>
        <p>
        ...
        <h2 className="text-h3 font-semibold text-charcoal">Children</h2>
        <p>
        ...
        <h2 className="text-h3 font-semibold text-charcoal">Where your data is stored</h2>
        <p>
        ...
        <h2 className="text-h3 font-semibold text-charcoal">Changes to this policy</h2>
        <p>
        ...
        <h2 className="text-h3 font-semibold text-charcoal">Contact us</h2>
        <p>
